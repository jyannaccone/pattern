 ...
 * a BinaryFactory implementation to be automatically configured after
 * instantiation.
 */
public interface ConfigurableBinaryFactory<T1 extends Configurable<T2>, T2 extends Configuration> {
   ...
   *         created instance
   */
  T1 create(String type1, String type2, T2 configuration) throws FactoryException, ConfigurationException;
