...
public final class ConfigurationUtil {
   ...
   * @throws Exception
   */
  public static <T> T cast(Configuration configuration,
      Class<T> configurationClass) throws Exception {
    
    if (!configurationClass.isInstance(configuration)) {
      
      throw new ConfigurationException("Invalid configuration type; expected " +
          configurationClass.getName() + ", found " +
